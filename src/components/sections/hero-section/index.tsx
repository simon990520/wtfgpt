        ...
        <div className="wrapper">
          <div className="max-w-[800px] mx-auto">
            <div className="text-center pb-16">
              <Subheading text="El Cerebro Extra que tu WhatsApp Necesitaba" />

              <h1 className="text-gray-700 mx-auto font-bold mb-4 text-4xl sm:text-[50px] dark:text-white/90 sm:leading-[64px] max-w-[700px]">
                Deja de Leer Chats, Empieza a Tomar el Control con WTF
              </h1>
              <p className="max-w-[537px] text-center mx-auto dark:text-gray-400 text-gray-500 text-base">
                El asistente inteligente que lee, analiza y entiende tus conversaciones de WhatsApp por ti. Transforma el caos en oportunidades reales de negocio.
              </p>
