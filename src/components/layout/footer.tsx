            ...
            <div className="lg:col-span-3 xl:col-span-4">
              <div>
                ...
                <p className="block text-sm text-gray-400 mb-9">
                  WTF es el asistente de inteligencia artificial definitivo para WhatsApp. Diseñado para empresas y profesionales que buscan automatizar su CRM y no perder ni una sola oportunidad de venta.
                </p>
                <div className="flex">
                  <a
                    href="#"
        ...
        <div className="container relative z-10 px-5 mx-auto sm:px-7">
          <div className="py-5 text-center">
            <p className="text-sm text-gray-500">
              &copy; {getCurrentYear()} WTF AI - Todos los derechos reservados.
            </p>
          </div>
        </div>
      </div>
